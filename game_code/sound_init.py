...
for_level_music = pygame.mixer.Sound(file=os.path.join("../data", 'sounds', 'hoi4mainthemeallies.wav'))
fif_level_music = pygame.mixer.Sound(file=os.path.join("../data", 'sounds', 'themightofsovietunion.wav'))
